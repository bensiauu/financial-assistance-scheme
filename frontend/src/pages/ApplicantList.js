              ...
              <TableRow>
                <TableCell colSpan={6} align="center">
                  <Typography variant="body1">
                    No applicants found. Click the "+" button to add a new one.
                  </Typography>
                </TableCell>
              </TableRow>
            ) : (
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            value={applicant.disability_status}
            onChange={handleApplicantChange}
            fullWidth
            margin="dense"
          />
          <TextField
            ...
            type="number"
            value={applicant.number_of_children}
            onChange={handleApplicantChange}
            fullWidth
            margin="dense"
          />
